...
export const listProducts = (keyword='', pageNumber = '') => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`/api/products/?keyword=${keyword}&pageNumber=${pageNumber}`, { mode: 'cors' })
...
export const listProductDetails = (id) => async (dispatch) => {
    try {
        ...
        const { data } = await axios.get(`/api/products/${id}`, { mode: 'cors' })
...
export const createProductReview = (productId, review) => async (dispatch, getState) => {
  ...
  export const listTopProduct = () => async (dispatch) => {
    try {
        dispatch({ type: PRODUCT_TOP_REQUEST, payload: [] })
        const { data } = await axios.get(`/api/products/topRated`, { mode: 'cors' })
