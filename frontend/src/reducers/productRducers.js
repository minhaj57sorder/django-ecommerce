...
export const productListReducer = (state = { products: [], pages:0,page:1 }, action) => {
    switch (action.type) {
...
export const productTopRatedReducer = (state = {topProducts:[]}, action) => {
    switch (action.type) {
        case PRODUCT_TOP_REQUEST:
            return { loadingTopProducts: true, topProducts:[] }
        case PRODUCT_TOP_SUCCESS:
            return { loading: false, topProducts: action.payload}
        case PRODUCT_TOP_FAIL:
            return { loading: false, errorTopProducts: action.payload }
        default:
            return state;
    }
}